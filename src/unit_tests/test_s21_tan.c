...
START_TEST(tan_test_7) { ck_assert_ldouble_nan(s21_tan(S21_INF)); }
END_TEST

START_TEST(tan_test_8) { ck_assert_ldouble_nan(tan(S21_INF)); }
END_TEST

START_TEST(tan_test_9) { ck_assert_ldouble_nan(s21_tan(-S21_INF)); }
END_TEST

START_TEST(tan_test_10) { ck_assert_ldouble_nan(tan(-S21_INF)); }
END_TEST
