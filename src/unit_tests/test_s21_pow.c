...
//   ck_assert_ldouble_eq_tol(s21_pow(839751.1234, 0.001),
//                            pow(839751.1234, 0.001), S21_EPSILON);
// }
END_TEST
...
START_TEST(pow_test_33) {
  ck_assert_ldouble_eq(s21_pow(-10.3, -S21_INF), pow(-10.3, -S21_INF));
}

START_TEST(pow_test_34) {
  ck_assert_ldouble_eq(s21_pow(-S21_INF, -4.6), pow(-S21_INF, -4.6));
}
...
START_TEST(pow_test_37) {
  ck_assert_ldouble_eq(s21_pow(0.3, -S21_INF), pow(0.3, -S21_INF));
}
