...
START_TEST(cos_test_12) { ck_assert_ldouble_nan(s21_cos(S21_INF)); }
END_TEST

START_TEST(cos_test_13) { ck_assert_ldouble_nan(cos(S21_INF)); }
END_TEST

START_TEST(cos_test_14) { ck_assert_ldouble_nan(s21_cos(-S21_INF)); }
END_TEST

START_TEST(cos_test_15) { ck_assert_ldouble_nan(cos(-S21_INF)); }
END_TEST
