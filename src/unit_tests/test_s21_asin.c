...
START_TEST(asin_test_12) { ck_assert_ldouble_nan(s21_asin(S21_INF)); }
END_TEST

START_TEST(asin_test_13) { ck_assert_ldouble_nan(asin(S21_INF)); }
END_TEST

START_TEST(asin_test_14) { ck_assert_ldouble_nan(s21_asin(-S21_INF)); }
END_TEST

START_TEST(asin_test_15) { ck_assert_ldouble_nan(asin(-S21_INF)); }
END_TEST
