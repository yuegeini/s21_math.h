...
START_TEST(sin_test_13) { ck_assert_ldouble_nan(s21_sin(S21_INF)); }
END_TEST

START_TEST(sin_test_14) { ck_assert_ldouble_nan(sin(S21_INF)); }
END_TEST

START_TEST(sin_test_15) { ck_assert_ldouble_nan(s21_sin(-S21_INF)); }
END_TEST

START_TEST(sin_test_16) { ck_assert_ldouble_nan(sin(-S21_INF)); }
END_TEST
