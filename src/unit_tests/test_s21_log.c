...
START_TEST(log_test_2) {
  ck_assert_ldouble_eq_tol(s21_log(0.001), log(0.001), S21_EPSILON);
}
END_TEST
...
START_TEST(log_test_8) { ck_assert_ldouble_eq(s21_log(S21_INF), log(S21_INF)); }
END_TEST

START_TEST(log_test_9) { ck_assert_ldouble_nan(s21_log(-S21_INF)); }
END_TEST

START_TEST(log_test_10) { ck_assert_ldouble_nan(log(-S21_INF)); }
END_TEST
