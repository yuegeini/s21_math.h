...
START_TEST(acos_test_12) { ck_assert_ldouble_nan(s21_acos(S21_INF)); }
END_TEST

START_TEST(acos_test_13) { ck_assert_ldouble_nan(acos(S21_INF)); }
END_TEST

START_TEST(acos_test_14) { ck_assert_ldouble_nan(s21_acos(-S21_INF)); }
END_TEST

START_TEST(acos_test_15) { ck_assert_ldouble_nan(acos(-S21_INF)); }
END_TEST
